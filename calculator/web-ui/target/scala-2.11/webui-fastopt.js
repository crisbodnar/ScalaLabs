...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  return new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      if (($uD(a$2.apply__O()) === 0)) {
        var array = [((-$uD(c$2.apply__O())) / $uD(b$2.apply__O()))];
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  return new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return (($uI(remainingCharsCount$1.apply__O()) >= 15) ? "green" : ((($uI(remainingCharsCount$1.apply__O()) >= 0) && ($uI(remainingCharsCount$1.apply__O()) < 15)) ? "orange" : "red"))
    })
  })(remainingCharsCount)))
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    var a = $as_T(x0$1.$$und1$f);
    var b = $as_Lcalculator_Signal(x0$1.$$und2$f);
    return new $c_T2().init___O__O(a, new $c_Lcalculator_Signal().init___F0(new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, b$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(b$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, b))))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
